#!/usr/bin/env python
# mypy: ignore-errors
# pertpy documentation build configuration file
import os
import sys
...
html_theme_options = {
    "icon_links": [
        ...
        {
            "name": "Twitter",
            "url": "https://twitter.com/scanpy_team",
...
.. raw:: html
    ...
    <div class="binder-badge docutils container">
        <a class="reference external image-reference"
           href="https://mybinder.org/v2/gh/theislab/pertpy/development?filepath={{ docname|e }}">
