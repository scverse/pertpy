...
* Add `num_chains` and `chain_method` parameters to `run_nuts` and `run_hmc` for vectorized multi-chain MCMC sampling on a single device, including GPU acceleration ([#1102](https://github.com/scverse/pertpy/pull/1102)) @mcuoco
