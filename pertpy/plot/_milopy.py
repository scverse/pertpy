...
class MilopyPlot:
    ...
    def nhood(
        ...
        **kwargs,
        ...
        sc.pl.embedding(adata, basis, color="Nhood",
                        size=30, title="Nhood" + str(ix), show=show, save=save, **kwargs)
    ...
    def DA_beeswarm(
        ...
        try:
            ...
            anno_palette = dict(zip(milo_mdata['cells'].obs[obs_col].cat.categories, milo_mdata['cells'].uns[f'{obs_col}_colors']))
