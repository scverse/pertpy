...
def mixscape(
    ...
    fine_mode_labels: Optional[str] = "guide_ID",
    ...
    Args:
        ...
        min_cells: Minimum number of cells in target gene class. If fewer than this many cells are assigned to a target gene class during classification, all are assigned NP.
    ...
    all_markers = [list(prtb_markers[key]) for key in prtb_markers.keys()][0]
    missing_genes = []
