...
class LookUp:
    ...
    def __init__(self, type: str = "cell_line", transfer_metadata: list[pd.DataFrame] | None = None):
        """
        Args:
            type: metadata type. Default: cell_line. Currrently, LookUp object is implemented for CellLineMetaData and MoaMetaData.
...
def available_compounds(
    ...
    Args:
        query_id_list: A list of unique compounds to test the number of matched ones present in the metadata. Defaults to None.
