...
class TestCinemaot:
    ...
    def test_unweighted(self):
        ...
        de = model.causaleffect(adata,pert_key='perturbation', control='No stimulation',return_matching=True,thres=0.5,smoothness=1e-5,eps=1e-3,solver='Sinkhorn')
    ...
    def test_pseudobulk(self):
        ...
        model = pt.tl.Cinemaot()
        de = model.causaleffect(adata,pert_key='perturbation', control='No stimulation',return_matching=True,thres=0.5,smoothness=1e-5,eps=1e-3,solver='Sinkhorn')
        adata_pb = model.generate_pseudobulk(adata,de,pert_key='perturbation', control='No stimulation',label_list=['cell_type0528'])
